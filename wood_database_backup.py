...
WOOD_SETTINGS: dict[str, dict[int, tuple[int, int]]] = {
    # Softwoods
    "Pine": {
        5:  ( 9000, 65),  10: (15000, 35),  20: (18000, 30),
        40: (24000, 30),  60: (30000, 25),  80: (36000, 25),
    },
    "Basswood": {
        5:  (12000, 70),  10: (18000, 40),  20: (21000, 35),
        40: (27000, 30),  60: (33000, 25),  80: (39000, 25),
    },
    "Poplar": {
        5:  (10500, 70),  10: (16500, 40),  20: (19500, 35),
        40: (25500, 30),  60: (31500, 25),  80: (37500, 25),
    },
    "Bamboo": {
        5:  (12000, 60),  10: (18000, 30),  20: (21000, 25),
        40: (27000, 25),  60: (33000, 20),  80: (39000, 20),
    },
    "Cedar": {
        5:  ( 9000, 70),  10: (15000, 40),  20: (18000, 35),
        40: (24000, 30),  60: (30000, 25),  80: (36000, 25),
    },
    "Cork": {
        5:  (18000, 25),  10: (21000, 20),  20: (24000, 15),
        40: (30000, 15),  60: (36000, 12),  80: (42000, 12),
    },

    # Medium hardwoods
    "Oak": {
        5:  ( 6000, 75),  10: (12000, 45),  20: (15000, 40),
        40: (21000, 35),  60: (27000, 30),  80: (33000, 30),
    },
    "Maple": {
        5:  ( 6000, 75),  10: (12000, 45),  20: (15000, 40),
        40: (21000, 35),  60: (27000, 30),  80: (33000, 30),
    ...
    "Cherry": {
        5:  ( 7500, 70),  10: (13500, 40),  20: (16500, 35),
        40: (22500, 30),  60: (28500, 25),  80: (34500, 25),
    },
    "Alder": {
        5:  ( 7500, 70),  10: (13500, 40),  20: (16500, 35),
        40: (22500, 30),  60: (28500, 25),  80: (34500, 25),
    ...
    "Padauk": {
        5:  ( 9000, 55),  10: (15000, 30),  20: (18000, 25),
        40: (24000, 25),  60: (30000, 20),  80: (36000, 20),
    },
    "Purpleheart": {
        5:  ( 9000, 55),  10: (15000, 30),  20: (18000, 25),
        40: (24000, 25),  60: (30000, 20),  80: (36000, 20),
    ...
    "MDF / HDF": {
        5:  ( 4800, 85),  10: ( 9000, 55),  20: (12000, 50),
        40: (18000, 45),  60: (24000, 40),  80: (30000, 40),
    },
...
def get_settings(wood_name: str, wattage: int) -> tuple[int, int] | None:
    ...
    for i in range(len(watts) - 1):
        if watts[i] <= wattage <= watts[i + 1]:
            ...
            return speed, power
    return None
d e f   g e t _ c u t _ s e t t i n g s ( w o o d _ n a m e :   s t r ,   w a t t a g e :   i n t )   - >   t u p l e [ i n t ,   i n t ]   |   N o n e :  
         " " " L o o k   u p   c u t t i n g   ( s p e e d _ m m _ m i n ,   p o w e r _ p e r c e n t )   f o r   t h r o u g h - c u t t i n g .  
  
         R e t u r n s   N o n e   i f   n o   e x a c t   m a t c h   e x i s t s .  
         " " "  
         i f   w o o d _ n a m e   n o t   i n   C U T _ S E T T I N G S :  
                 r e t u r n   N o n e  
         s e t t i n g s   =   C U T _ S E T T I N G S [ w o o d _ n a m e ]  
         i f   w a t t a g e   i n   s e t t i n g s :  
                 r e t u r n   s e t t i n g s [ w a t t a g e ]  
         #   I n t e r p o l a t e   b e t w e e n   n e a r e s t   w a t t a g e s  
         w a t t s   =   s o r t e d ( s e t t i n g s . k e y s ( ) )  
         i f   w a t t a g e   <   w a t t s [ 0 ]   o r   w a t t a g e   >   w a t t s [ - 1 ] :  
                 r e t u r n   N o n e  
         f o r   i   i n   r a n g e ( l e n ( w a t t s )   -   1 ) :  
                 i f   w a t t s [ i ]   < =   w a t t a g e   < =   w a t t s [ i   +   1 ] :  
                         w 1 ,   w 2   =   w a t t s [ i ] ,   w a t t s [ i   +   1 ]  
                         s 1 ,   p 1   =   s e t t i n g s [ w 1 ]  
                         s 2 ,   p 2   =   s e t t i n g s [ w 2 ]  
                         r a t i o   =   ( w a t t a g e   -   w 1 )   /   ( w 2   -   w 1 )  
                         s p e e d   =   i n t ( s 1   +   ( s 2   -   s 1 )   *   r a t i o )  
                         p o w e r   =   i n t ( p 1   +   ( p 2   -   p 1 )   *   r a t i o )  
                         r e t u r n   s p e e d ,   p o w e r  
         r e t u r n   N o n e  
 